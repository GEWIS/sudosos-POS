...
export default class FakeProducts {
  ...
  public static fetchProducts(): Product[] {
    return [this.beugel, this.tripel, this.alcoholFree, this.cocktail];
  }
}
