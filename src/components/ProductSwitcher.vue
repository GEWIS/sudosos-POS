...
export default class ProductSwitcher extends Vue {
  // *************************************************
  //
  //               Begin test data
  //
  ...
  beugel: Product = {
    ...
    ownerId: '1',
    price: 110,
    picture: 'https://deklokdranken.blob.core.windows.net/product-images/101007.jpg',
    traySize: 20,
    category: 'drink',
    isAlcoholic: true,
    negative: false,
  ...
  radler: Product = {
    ...
    ownerId: '1',
    price: 50,
    picture: 'https://deklokdranken.blob.core.windows.net/product-images/1021123.jpg',
    traySize: 1,
    category: 'drink',
    isAlcoholic: true,
    negative: false,
  ...
  cola: Product = {
    ...
    ownerId: '2',
    price: 70,
    picture: 'https://deklokdranken.blob.core.windows.net/product-images/201003.jpg',
    traySize: 1,
    category: 'drink',
    isAlcoholic: false,
    negative: false,
  ...
  cassis: Product = {
    ...
    ownerId: '2',
    price: 70,
    picture: 'https://deklokdranken.blob.core.windows.net/product-images/205053.jpg',
    traySize: 1,
    category: 'drink',
    isAlcoholic: false,
    negative: false,
  ...
  fristi: Product = {
    ...
    ownerId: '2',
    price: 90,
    picture: 'https://deklokdranken.blob.core.windows.net/product-images/242052.jpg',
    traySize: 1,
    category: 'drink',
    isAlcoholic: false,
    negative: false,
